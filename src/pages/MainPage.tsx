  ...
  useEffect(() => {
    productAPI.getAll()
      ...
      .catch(() => {
        ...
        setProducts([
          { id: 1, product_name: '사과', product_price: 1000, product_category: 'food', product_detail: '아삭한 사과', stock: 50 },
          { id: 2, product_name: '키보드', product_price: 39000, product_category: 'tech', product_detail: '기계식 키보드', stock: 10 },
        ]);
      });
  }, []);
